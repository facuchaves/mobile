...
const traduccion = merge(origin, {
  ...
  ficha_aviso: {
    ...
    label_salario: 'Ingresa tu salario bruto pretendido',
    label_check_salario: 'Actualizar salario en mi HV',
    pregunta: {
    ...
    carta_presentacion: {
      ...
      text_result_skip: 'En tu próxima postulación, completa la carta y aprovecha para lucirte.',
    },
    activa_mail_o_completa_cv: 'Activa tu cuenta o completa tu HV para que la enviemos.',
  },
  mis_postulaciones: {
    order: 'Ordenar por: ',
  ...
  curriculum: {
    ...
    salario: {
      salario: salario => (salario ? `$${salario} bruto` : `Ingresa tu salario bruto pretendido`),
      title_edit: 'Ingresa tu salario bruto pretendido',
    },
    objetivo: {
    ...
    ajustes: {
      notificaciones: {
        ...
        edit: {
          ...
          envios: {
            text: 'Envío semanal de ofertas laborales que se relacionan con tus búsquedas y tu HV. ',
          },
          actividad: {
            text: 'Envío mensual de la actividad entre las empresas y tu HV.',
          },
          especiales: {
      ...
      cuenta: {
        subtitle: 'Modifica la privacidad de tu HV, cambia la contraseña o elimina tu cuenta. ',
        perfil: {
          change_password_subtitle: 'Modifica tu contraseña actual por una nueva.',
          repetir: 'Repite tu nueva contraseña',
          privacidad_title: 'Privacidad de mi HV',
          privacidad_privado: 'Tu HV es visible únicamente en los avisos a los que te postulaste.',
          privacidad_publico:
            'Tu HV es visible en los avisos a los que te postulaste y en otras búsquedas que realizan las empresas. ',
          delete_subtitle:
            'Si eliminas tu cuenta de Konzerta, no podrás postularte a más ofertas de trabajo ni revisar tus postulaciones.',
  ...
  validation: {
    ...
    error_salario: 'Ingresa un salario.',
