...
const traduccion = merge(origin, {
  ...
  ficha_aviso: {
    ...
    label_check_salario: 'Actualizar sueldo en mi HV',
    pregunta: {
    ...
    ajustes: {
      ...
      cuenta: {
        ...
        perfil: {
          ...
          delete_subtitle:
            'Si eliminas tu cuenta de Multitrabajos, no podrás postularte a más ofertas de trabajo ni revisar tus postulaciones.',
