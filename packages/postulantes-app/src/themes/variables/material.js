...
// SET THEME COLOR FOR THEME

const brandPrimary = '#329af0'
const brandSecondary = '#51cf66'
const brandAlternative = '#505050'
...
const bootonBarBg = brandPrimary
const bootonBarText = '#fff'
const bootonBarTextActive = '#000'
...
export default {
  ...
  // Tab
  tabDefaultBg: '#FFF',
  topTabBarTextColor: brandPrimary,
  topTabBarActiveTextColor: brandPrimary,
  topTabBarBorderColor: brandPrimary,
