/* eslint-disable */
function newRelicScript(licenseKeyInput, applicationIDInput) {
  window.NREUM || (NREUM = {}),
          ...
          function(t, e, n) {
            ...
            if (w[v] && x.xhrWrappable) {
              ...
              N.on(u, r),
                ...
                N.on(d, o),
                N.on(l, o),
                N.buffer([u, d, 'xhr-done', 'xhr-resolved']),
                R.buffer([u]),
                ...
                S.buffer([u, 'no-' + u]),
                T.buffer(['new-jsonp', 'cb-start', 'jsonp-error', 'jsonp-end']),
                a(P, 'send-xhr' + s),
                a(N, 'xhr-resolved'),
                a(N, 'xhr-done'),
                a(C, m + s),
        ...
        14: [
          function(t, e, n) {
            ...
            if (
              ...
              d.inPlace(g.prototype, ['open', 'send'], '-xhr-', s),
            ...
            function r(t) {
              ...
              if (!this.ended) {
                ...
                e.aborted ||
                  ...
                  this.loadCaptureCalled || 4 !== t.readyState ? null == e.status && (e.status = 0) : a(this, t),
              ...
              ;(s.features.xhr = !0),
                ...
                d.on('fn-start', function(t, e, n) {
                  e instanceof w &&
                    ...
                    ('load' === (t[0] && t[0].type) || this.onload) && (this.xhrCbStart = s.now()))
                }),
...
export function insertNewRelicScriptInDocument(licenseKey, applicationID, document) {
  const s = document.createElement('script')
  s.innerHTML = `${newRelicScript}; newRelicScript('${licenseKey}', '${applicationID}');`
